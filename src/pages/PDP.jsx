...
const ProductPage = () => {
  ...
  return (
    <div
      className="h-screen bg-blue-200 pt-20 max-md:pt-4 max-md:h-screen"
      dir="rtl"
    >
      ...
      <div className="w-[55%] max-md:flex-col rounded-3xl m-auto h-[22rem] flex overflow-hidden max-md:h-auto  max-md:w-[95%]">
        <div className="bg-blue-600 max-md:w-auto w-[53%] grid justify-end">
          ...
          <div className="w-full">
            <div className="bg-green-600 max-md:w-auto w-fit rounded-2xl h-fit py-3 px-6 text-white mb-4 mx-auto max-md:hidden">
              پشتیبانی 24 ساعته
            </div>
          </div>
        </div>
        <div className="bg-blue-50 max-md:w-auto w-[47%] flex">
      ...
      <div className="w-[55%] m-auto mt-10">
        <button className="bg-blue-600 rounded-3xl w-full text-white h-20 text-3xl font-extrabold  max-md:mb-4  max-md:w-full  max-md:px-4 hover:scale-105 transition duration-500 hover:text-blue-600 hover:bg-white">
          نهایی کردن خرید!
        </button>
      </div>
    </div>
